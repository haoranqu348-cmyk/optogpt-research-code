...
import sys
import os
# Add the parent optogpt package to path (relative to this script's location)
sys.path.append(os.path.join(os.path.dirname(__file__), '..'))
import numpy as np
import torch
from optogpt.core.datasets.sim import load_materials, inc_tmm
import math
...
NK_DICT = load_materials(all_mats=MATERIALS, wavelengths=WAVELENGTHS, DATABASE=os.path.join(os.path.dirname(__file__), '..', 'optogpt', 'nk'))
